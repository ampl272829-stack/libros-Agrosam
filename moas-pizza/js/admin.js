(function () {
  ...
  function loadData() {
    const stored = localStorage.getItem('moas-pizza_admin');
    if (stored) {
  ...
  function saveData() {
    localStorage.setItem('moas-pizza_admin', JSON.stringify({ CONFIG: CFG, MENU, RESENAS }));
  }
  ...
  function exportData() {
    ...
    a.href = url;
    a.download = 'moas-pizza-data.json';
    a.click();
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('logoutBtn').addEventListener('click', () => {
      localStorage.removeItem('moas-pizza_admin');
